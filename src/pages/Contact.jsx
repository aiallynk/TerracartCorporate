...
export default function Contact() {
  return (
    <>
      ...
      <div className="home-panels nav-island-underlay min-h-screen">
        <section className="section-shell contact-heading">
          <div className="text-center">
            <h1 className="section-title">Contact Us</h1>
            <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed md:text-lg">
        ...
        <section className="section-shell contact-address">
          <div className="mx-auto max-w-4xl border-t pt-6 text-center">
            <h2 className="text-lg font-semibold md:text-xl">Home Office Address</h2>
            <p className="mx-auto mt-3 max-w-3xl text-[0.98rem] leading-[1.8] md:text-[1.08rem]">
